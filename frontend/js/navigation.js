...
function showLogoutModal() {
    ...
    modal.innerHTML = `
        <div class="bg-white rounded-lg shadow-xl p-6 max-w-sm w-full mx-4" style="animation: slideIn 0.3s ease-out;">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-2 text-center">Sign Out</h3>
            <p class="text-gray-600 mb-6 text-center">Are you sure you want to sign out?</p>
            <div class="flex space-x-3">
                <button onclick="closeLogoutModal()" class="flex-1 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg font-medium transition">
                    Cancel
                </button>
                <button onclick="confirmLogout()" class="flex-1 px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg font-medium transition">
                    Sign Out
                </button>
            </div>
        </div>
